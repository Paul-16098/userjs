...
class BookManager {
    ...
    hookAlert() {
        ...
        unsafeWindow.jqTip = (i) => {
            if (!config.HookAlertBlockade.some((blockade) => JSON.stringify([i]) === JSON.stringify(blockade) ||
                JSON.stringify(blockade) === "*")) {
                _jqTip(i);
            }
            if (config.Debug) {
...
//# sourceMappingURL=https://github.com/Paul-16098/userjs/raw/dev/69shuba%20auto%20%E6%9B%B8%E7%B0%BD/69shuba%20auto%20%E6%9B%B8%E7%B0%BD.user.js.map