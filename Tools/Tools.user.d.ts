...
declare function GetOrWaitForElement<T extends Element>(selector: Parameters<typeof document.querySelector>[0], timeout?: number): Promise<T & NonNullable<ReturnType<typeof document.querySelector>>>;
